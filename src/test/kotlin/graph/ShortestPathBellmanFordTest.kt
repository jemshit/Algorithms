...
internal class ShortestPathBellmanFordTest {
    ...
    fun `shortest Path`() {
        ...
        val shortestPaths = graph.shortestPathBellmanFord()
    ...
    @Test
    fun `shortest Path negative cycle`() {
        val graph = GraphUsingAdjacencyList(directed = true, nodeCount = 2)
        graph.addEdge(start = 0, end = 1, weight = -3)
        graph.addEdge(start = 1, end = 0, weight = 1)
